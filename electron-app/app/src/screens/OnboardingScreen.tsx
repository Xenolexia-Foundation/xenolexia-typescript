...
export function OnboardingScreen(): React.JSX.Element {
  ...
  const [sourceLanguage, setSourceLanguage] = useState<Language>(preferences.defaultSourceLanguage);
  const [targetLanguage, setTargetLanguage] = useState<Language>(preferences.defaultTargetLanguage);
      ...
      <div className="onboarding-content">
        {step === 'welcome' && (
          <Card variant="outlined" padding="lg" className="onboarding-card">
            ...
            <p className="onboarding-description">
              Learn languages through the stories you love. Set your preferences below, or skip to
        ...
        {step === 'language' && (
          <Card variant="outlined" padding="lg" className="onboarding-card">
            ...
            <p className="onboarding-description">
              Choose the language you&apos;re reading from and the one you&apos;re learning.
            </p>
        ...
        {step === 'proficiency' && (
          <Card variant="outlined" padding="lg" className="onboarding-card">
            ...
            <p className="onboarding-description">
              How well do you know the target language? This affects which words get translated.
            </p>
            <div className="onboarding-options">
              {(['beginner', 'intermediate', 'advanced'] as const).map(level => (
                <button
                  key={level}
                  type="button"
                  className={`onboarding-option ${proficiency === level ? 'selected' : ''}`}
        ...
        {step === 'density' && (
          <Card variant="outlined" padding="lg" className="onboarding-card">
            ...
            <p className="onboarding-description">
              What percentage of words should be replaced with translations? Higher = more words
            ...
            <div className="onboarding-slider-row">
              ...
              />
              <span className="onboarding-value">{Math.round(density * 100)}%</span>
            </div>
          </Card>
        )}
        ...
        {step === 'done' && (
          <Card variant="outlined" padding="lg" className="onboarding-card">
            ...
            <p className="onboarding-description">
              {getLanguageInfo(sourceLanguage)?.name} → {getLanguageInfo(targetLanguage)?.name},{' '}
              {proficiency}, {Math.round(density * 100)}% density. You can change these anytime in
              Settings.
            </p>
          </Card>
        )}
        ...
        <div className="onboarding-actions">
          {canSkip && (
            <Button variant="outline" onClick={handleSkip} className="onboarding-skip">
              Skip
            </Button>
          )}
