...
describe('ExportService', () => {
  ...
  describe('export', () => {
    ...
    it('should include context when option is set', async () => {
      const vocabulary = [createMockVocabularyItem({contextSentence: 'Test context sentence'})];
    ...
    it('should include SRS data when option is set', async () => {
      const vocabulary = [createMockVocabularyItem({easeFactor: 2.5, interval: 10})];
  ...
  describe('CSV generation', () => {
    it('should escape commas in CSV values', async () => {
      const vocabulary = [createMockVocabularyItem({sourceWord: 'hello, world'})];
    ...
    it('should escape quotes in CSV values', async () => {
      const vocabulary = [createMockVocabularyItem({sourceWord: 'say "hello"'})];
  ...
  describe('Anki format', () => {
    ...
    it('should use tab separator', async () => {
      const vocabulary = [createMockVocabularyItem({targetWord: 'hola', sourceWord: 'hello'})];
