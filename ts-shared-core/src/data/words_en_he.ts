 ...
 * English-HE dictionary: 500 beginner words (frequency-ranked).
 * Run scripts/fetch-translations.js he && scripts/build-words-from-translations.js he for real translations.
 */
...
export const ALL_WORDS_EN_HE: WordData[] = [...BEGINNER_WORDS];
