 ...
 * English-Persian dictionary: 500 beginner words (frequency-ranked).
 * Run scripts/fetch-translations.js fa && scripts/build-words-from-translations.js fa for real translations.
 */
