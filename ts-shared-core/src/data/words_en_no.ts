 ...
 * English-NO dictionary: 500 beginner words (frequency-ranked).
 * Run scripts/fetch-translations.js no && scripts/build-words-from-translations.js no for real translations.
 */
...
export const ALL_WORDS_EN_NO: WordData[] = [...BEGINNER_WORDS];
