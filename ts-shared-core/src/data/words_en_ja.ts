 ...
 * English-JA dictionary: 500 beginner words (frequency-ranked).
 * Run scripts/fetch-translations.js ja && scripts/build-words-from-translations.js ja for real translations.
 */
...
export const ALL_WORDS_EN_JA: WordData[] = [...BEGINNER_WORDS];
