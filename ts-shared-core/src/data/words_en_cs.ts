 ...
 * English-CS dictionary: 500 beginner words (frequency-ranked).
 * Run scripts/fetch-translations.js cs && scripts/build-words-from-translations.js cs for real translations.
 */
...
export const ALL_WORDS_EN_CS: WordData[] = [...BEGINNER_WORDS];
