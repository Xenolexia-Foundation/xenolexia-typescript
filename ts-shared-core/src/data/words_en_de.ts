 ...
 * English-DE dictionary: 500 beginner words (frequency-ranked).
 * Run scripts/fetch-translations.js de && scripts/build-words-from-translations.js de for real translations.
 */
...
export const ALL_WORDS_EN_DE: WordData[] = [...BEGINNER_WORDS];
