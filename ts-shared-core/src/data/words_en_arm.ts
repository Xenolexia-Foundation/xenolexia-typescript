 ...
 * English-Aramaic dictionary: 500 beginner words (frequency-ranked).
 * Run scripts/fetch-translations.js arm && scripts/build-words-from-translations.js arm for real translations.
 */
