 ...
 * English-TH dictionary: 500 beginner words (frequency-ranked).
 * Run scripts/fetch-translations.js th && scripts/build-words-from-translations.js th for real translations.
 */
...
export const ALL_WORDS_EN_TH: WordData[] = [...BEGINNER_WORDS];
