 ...
 * English-TR dictionary: 500 beginner words (frequency-ranked).
 * Run scripts/fetch-translations.js tr && scripts/build-words-from-translations.js tr for real translations.
 */
...
export const ALL_WORDS_EN_TR: WordData[] = [...BEGINNER_WORDS];
