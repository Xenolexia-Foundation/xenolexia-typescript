 ...
 * English-KO dictionary: 500 beginner words (frequency-ranked).
 * Run scripts/fetch-translations.js ko && scripts/build-words-from-translations.js ko for real translations.
 */
...
export const ALL_WORDS_EN_KO: WordData[] = [...BEGINNER_WORDS];
