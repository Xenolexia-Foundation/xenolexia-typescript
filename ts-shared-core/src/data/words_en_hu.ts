 ...
 * English-HU dictionary: 500 beginner words (frequency-ranked).
 * Run scripts/fetch-translations.js hu && scripts/build-words-from-translations.js hu for real translations.
 */
...
export const ALL_WORDS_EN_HU: WordData[] = [...BEGINNER_WORDS];
