 ...
 * English-SV dictionary: 500 beginner words (frequency-ranked).
 * Run scripts/fetch-translations.js sv && scripts/build-words-from-translations.js sv for real translations.
 */
...
export const ALL_WORDS_EN_SV: WordData[] = [...BEGINNER_WORDS];
