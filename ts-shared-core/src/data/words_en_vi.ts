 ...
 * English-VI dictionary: 500 beginner words (frequency-ranked).
 * Run scripts/fetch-translations.js vi && scripts/build-words-from-translations.js vi for real translations.
 */
...
export const ALL_WORDS_EN_VI: WordData[] = [...BEGINNER_WORDS];
